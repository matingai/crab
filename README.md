...
This prints the system prompt, workspace context, goal-state digest, memory snapshot,
runtime profile, and tool definitions that would be sent to a model. It is the fastest
way to see the agent-loop shape before configuring a provider.
