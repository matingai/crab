...
- Added a conservative `computer_use` foundation for macOS Accessibility-backed native
  ...
  snapshots, snapshot-bound approval-gated ref clicks/text setting, docs, and `doctor`
  visibility. Global keyboard and broad app-control write actions remain intentionally
  disabled.
