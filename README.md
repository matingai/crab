...
- Native computer-use preparation through macOS Accessibility status, permission prompt,
  ...
  ref search, and UI waits, pre-action ref guards, snapshot-bound focus/click/text/scroll
  actions, whitelisted native Accessibility actions, and whitelisted key presses.
