...
- Native computer-use preparation through macOS Accessibility status, permission prompt,
  ...
  ref search, text appear/disappear UI waits, ref readiness waits, pre-action ref guards,
  native action availability guards, snapshot-bound focus/click/text/scroll actions,
